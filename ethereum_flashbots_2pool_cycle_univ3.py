...
from dto.v3_tick_lens import TickLens
from dto.abi import *
from dto.v3_liquidity_pool import V3LiquidityPool
from dto.v2_liquidity_pool import LiquidityPool
...
# newest_block,first_event_block,first_new_block
...
# lp_helper.update_reserves lp_helper.auto_update
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    # message = json.loads(await websocket.recv())
                # if no event has been received in _TIMEOUT seconds, assume all events have been received,
                # reduce the list of arbs to check with set(), repackage and send for processing,
                # then clear the working queue
